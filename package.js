...
export var scripts = {"serve":"gulp -o d3-rs-tip -g d3-selection -g d3-collection -g @redsift/d3-rs-svg serve","build":"gulp -o d3-rs-tip -g d3-selection -g d3-collection -g @redsift/d3-rs-svg build","pretest":"npm outdated && npm run build","test":"tape 'test/**/*-test.js' && eslint index.js src","version":"json2module package.json > package.js","prepublish":"npm run build"};
export var dependencies = {"@redsift/d3-rs-svg":"~0.2.3","d3-selection":"~0.8.0"};
